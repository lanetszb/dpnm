...
#                          tight_layout=True)
#
# plot_x_y(data.index, data.U_outlet_av, 'time, $sec$', '$U_{out}, m/sec$', '',
#          '-', label='DFS', zorder=0)
# plt.scatter([0.005030000000000004], [0.056077], marker="o", c='g', s=45,
#             label="$0.00503 \; sec$ (DFS)", zorder=1)
# plot_x_y(data.index, data.U_outlet_p, 'time, $sec$', '$U_{out}, m/sec$', '',
#          '-', label='PNM', zorder=0)
#
# plt.legend()
# # plt.plot()
# plt.savefig('../output/coupling_valid.eps', format="eps",
#             bbox_inches='tight')